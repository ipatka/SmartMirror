...
class Controller_Scrape extends Controller_Base {
    ...
    private function gettidelinks() {// returns array (number of links, link1, link2 if necessary)
    ...
    private function getdatabyclass($link,$classname) {
        ...
        if(!empty($html)){
            ...
            foreach ($nodes as $node) {
                $temparray = $this->tdrows_to_array($node->childNodes);
    ...
    $links = $this->gettidelinks();
    $number_of_links = $links[0];
    // echo $number_of_links;
    if ($number_of_links > 1) {
        $tidesarray1 = $this->getdatabyclass($links[1],"tide-row");
        $tidesarray2 = $this->getdatabyclass($links[2],"tide-row");
        ...
        $tidesarray = $this->getdatabyclass($links[1],"tide-row");
